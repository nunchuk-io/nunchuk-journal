...
Similar to other one-way functions, reverse-engineering ECDSA is super hard, and there is no
...
(e.g. Pay-to-Script-Hash or P2SH). For more on this, read [this article](https://github.com/nunchuk-io/nunchuk-journal/blob/main/keys-are-not-enough.md).
